...
.factory('fireBaseData', function($firebase) {
  var ref = new Firebase("https://tio-papinhas.firebaseio.com/"),
    refCart = new Firebase("https://tio-papinhas.firebaseio.com/cart"),
    refUser = new Firebase("https://tio-papinhas.firebaseio.com/users"),
    refCategory = new Firebase("https://tio-papinhas.firebaseio.com/category"),
    refOrder = new Firebase("https://tio-papinhas.firebaseio.com/orders"),
    refFeatured = new Firebase("https://tio-papinhas.firebaseio.com/featured"),
    refMenu = new Firebase("https://tio-papinhas.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
